...
const ShopeLocation = () => {
    ...
    return (
        <div className='bg-[#41414e1a]  z-[99] relative overflow-hidden bg-white'>
            <div className={`max-w-[1800px] m-auto px-[20px]  ${location.pathname !== '/' ? 'pt-[50px] lg:mt-[100px]' : ' pt-[35px] '}`}>
                <div className='text-center pb-[50px]'>
                    <h1 className={`xl:text-[50px] font-lato font-bold border-b inline-block border-black`}>
                        OUR SHOP LOCATIONS
                    </h1>
                </div>
                <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-[30px] mb-[30px]'>
